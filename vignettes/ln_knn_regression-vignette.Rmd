...
scatter_plot(knn_prediction, Sepal.Width, Sepal.Length, "Sepal Width", "Sepal Length", "Linear Regression Model for Sepal Length", 10) + ggplot2::geom_line(data = knn_prediction, 
